...
patient data, and open team science. [_**Learn more...**_](about.md).

This site hosts the official technical documentation for Translator. Key sections of the documentation are:

- [About the Biomedical Data Translator](about.md): general information about the Biomedical Data Translator ("Translator") project.
