...
[[Expander Agent|Expander Agent Page]].
...
* _Modes of Access_ 
    ...
    * Download RTX-KG2 knowledge graph in [KGX TSV](https://github.com/biolink/kgx/blob/master/specification/kgx-format) format from the [NCATS GitHub git-lfs repository](https://github.com/ncats/translator-lfs-artifacts/tree/main/files).
    * Build your own RTX-KG2: [[https://github.com/RTXteam/RTX-KG2#how-to-build-rtx-kg2-from-its-upstream-sources]]
...
**Knowledge Sources Accessed** - See the [[https://github.com/RTXteam/RTX/tree/master/code/kg2#what-data-sources-are-used-in-kg2]] for details.
